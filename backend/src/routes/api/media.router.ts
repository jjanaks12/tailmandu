...
router.post('/uncategorized/images', [verifyAccessToken], MediaController.addUncategorizedImages)
...
router.post('/link-images', [verifyAccessToken], MediaController.linkImages)

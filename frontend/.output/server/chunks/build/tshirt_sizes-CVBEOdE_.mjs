...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { shirtSizes } = storeToRefs(useAppStore());
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><h1 class="text-primary text-2xl mb-4">T-shirt sizes</h1>`);
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_TableBody, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(shirtSizes), (shirtSize, index) => {
                    _push3(ssrRenderComponent(_component_TableRow, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(_component_TableCell, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate(shirtSize.name)}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString(shirtSize.name), 1)
                                ];
                              }
                            }),
                            _: 2
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(shirtSizes), (shirtSize, index) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dashboard/tshirt_sizes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=tshirt_sizes-CVBEOdE_.mjs.map

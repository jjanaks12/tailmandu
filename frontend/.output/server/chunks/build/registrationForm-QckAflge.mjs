                      ...
                      _push3(ssrRenderComponent(_component_Label, {
                        ...
                        default: withCtx((_, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            _push4(`<div class="grow flex flex-col gap-2"${_scopeId3}><span class="font-medium text-gray-700"${_scopeId3}>I want to order lunch after race.</span><em class="text-sm font-light not-italic"${_scopeId3}>Please Note*: Lunch is only provided to those who pre- ordered and pre-paid which is 480 per person and not included in registration fee.</em></div>`);
                          } else {
                            return [
                              ...
                              createVNode("div", { class: "grow flex flex-col gap-2" }, [
                                createVNode("span", { class: "font-medium text-gray-700" }, "I want to order lunch after race."),
...
//# sourceMappingURL=registrationForm-QckAflge.mjs.map

import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, createElementBlock, ref, watch, hasInjectionContext, inject, computed, defineAsyncComponent, h, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, withCtx, createBlock, createCommentVNode, openBlock, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope } from 'vue';
import { h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, $ as $fetch, m as createHooks, n as executeAsync, c as createError$1, t as toRouteMatcher, o as createRouter$1, p as defu, q as destr, r as klona, v as parse, x as getRequestHeader, y as isEqual, z as setCookie, A as getCookie, B as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./index-CbywQ5bh.mjs')
  },
  {
    name: "races",
    path: "/races",
    component: () => import('./races-DagQy8re.mjs')
  },
  {
    name: "about_us",
    path: "/about_us",
...
const layouts = {
  "admin-sidebar": defineAsyncComponent(() => import('./_sidebar-DTW3GOEf.mjs').then((m) => m.default || m)),
  admin: defineAsyncComponent(() => import('./index-U7UKAqa1.mjs').then((m) => m.default || m)),
  "default-footer": defineAsyncComponent(() => import('./_footer-BgpHzCBS.mjs').then((m) => m.default || m)),
  "default-header": defineAsyncComponent(() => import('./_header-BegYgRno.mjs').then((m) => m.default || m)),
  "default-sidebar": defineAsyncComponent(() => import('./_sidebar-BtWxciwL.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./index-De6ybRg_.mjs').then((m) => m.default || m)),
...
const useAxios = () => {
  ...
  instance.interceptors.response.use((response) => response, async (error) => {
    ...
    toast({
      title: error.message,
      description: (_c = (_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) == null ? void 0 : _c.message,
      variant: "destructive"
    });
    return error;
  });
...
const useAuthStore = defineStore("auth", () => {
  ...
  const permissions = computed(() => {
    var _a, _b;
    return ((_b = (_a = user.value) == null ? void 0 : _a.role) == null ? void 0 : _b.permissions.map((permission) => permission.name)) || [];
  });
  const isLoggedin = computed(() => token.value != null);
  computed(() => {
    var _a;
    return showImage((_a = user.value) == null ? void 0 : _a.personal.avatar.file_name);
  });
  const fullName = computed(() => {
    var _a, _b, _c;
    return [(_a = user.value) == null ? void 0 : _a.personal.first_name, (_b = user.value) == null ? void 0 : _b.personal.middle_name, (_c = user.value) == null ? void 0 : _c.personal.last_name].join(" ").trim();
  });
  const role = computed(() => {
    var _a, _b;
    return (_b = (_a = user.value) == null ? void 0 : _a.role) == null ? void 0 : _b.name;
  });
  const fetch = async () => {
    ...
    try {
      if (token.value != null) {
        const { data } = await axios2.post("/refresh-token", {
          refreshToken: (_a = token.value) == null ? void 0 : _a.refreshToken
        });
        token.value = data;
      }
      resolve(true);
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              !unref(isLoading) ? (openBlock(), createBlock(_component_NuxtPage, { key: 0 })) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CMhDlEAb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Ttji14lO.mjs'));
...
export { __nuxt_component_0$1 as _, useAppStore as a, usePermissionStore as b, useRoleStore as c, useModalMeta as d, entry$1 as default, useAxios as e, useRuntimeConfig as f, useRouter as g, useNuxtApp as h, isObjEq as i, nuxtLinkDefaults as j, defineNuxtRouteMiddleware as k, useRoute as l, navigateTo as n, resolveRouteObject as r, showImage as s, tryUseNuxtApp as t, useAuthStore as u };

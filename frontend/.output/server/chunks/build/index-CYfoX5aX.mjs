...
/* @__PURE__ */ defineComponent({
  ...
  setup(n) {
    ...
    const m = computed(() => a.yAxis.map((e) => (t) => t[e])), p = (e, t) => Object.values(a.categories)[t].color, g = computed(
      () => a.legendPosition === l.Top
    ), y = computed(() => (e, t) => {
      return "";
    });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex" }, _attrs))}><div class="w-1/2">`);
...
//# sourceMappingURL=index-CYfoX5aX.mjs.map

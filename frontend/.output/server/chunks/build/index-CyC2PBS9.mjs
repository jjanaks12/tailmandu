...
import { defineComponent, ref, unref, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString, useSSRContext } from 'vue';
...
import { _ as _sfc_main$3 } from './index-CIwfCEWF.mjs';
import { MapIcon } from 'lucide-vue-next';
import { _ as _sfc_main$2 } from './Button-BQvwvVGk.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        to: `/races/${_ctx.raceSlug}/stage/${_ctx.stage.id}`,
        class: "shadow"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<figure class="relative"${_scopeId}><img${ssrRenderAttr("src", unref(showImage)(_ctx.stage.thumbnail.file_name))}${ssrRenderAttr("alt", _ctx.stage.name)}${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Badge, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(formatDate)(_ctx.stage.start))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(formatDate)(_ctx.stage.start)), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</figure><div class="px-7 space-y-5 pb-7"${_scopeId}><ul class="bg-[#13304a] text-white/80 flex gap-4 px-[30px] py-[17px] -mt-4 [&amp;&gt;li&gt;strong]:block [&amp;&gt;li&gt;em]:text-[#4487a0] [&amp;&gt;li&gt;em]:capitalize [&amp;&gt;li&gt;em]:not-italic relative z-[2] rounded-sm"${_scopeId}><li${_scopeId}><em${_scopeId}>${ssrInterpolate(_ctx.stage.distance)}</em><strong${_scopeId}>Distance</strong></li><li${_scopeId}><em${_scopeId}>${ssrInterpolate(_ctx.stage.difficulty)}</em><strong${_scopeId}>Difficulty</strong></li></ul><em class="text-[#13304a] text-3xl not-italic block"${_scopeId}>${ssrInterpolate(_ctx.raceName)}</em><h3 class="text-primary"${_scopeId}>${ssrInterpolate(_ctx.stage.name)}</h3><address class="not-italic flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(MapIcon), null, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(_ctx.stage.location)}</address></div>`);
          } else {
            return [
              createVNode("figure", { class: "relative" }, [
                createVNode("img", {
                  src: unref(showImage)(_ctx.stage.thumbnail.file_name),
                  alt: _ctx.stage.name
                }, null, 8, ["src", "alt"]),
              ...
              createVNode("div", { class: "px-7 space-y-5 pb-7" }, [
                createVNode("ul", { class: "bg-[#13304a] text-white/80 flex gap-4 px-[30px] py-[17px] -mt-4 [&>li>strong]:block [&>li>em]:text-[#4487a0] [&>li>em]:capitalize [&>li>em]:not-italic relative z-[2] rounded-sm" }, [
                  createVNode("li", null, [
                    createVNode("em", null, toDisplayString(_ctx.stage.distance), 1),
                    createVNode("strong", null, "Distance")
                  ]),
                  createVNode("li", null, [
                    createVNode("em", null, toDisplayString(_ctx.stage.difficulty), 1),
                    createVNode("strong", null, "Difficulty")
                  ])
                ]),
                createVNode("em", { class: "text-[#13304a] text-3xl not-italic block" }, toDisplayString(_ctx.raceName), 1),
                createVNode("h3", { class: "text-primary" }, toDisplayString(_ctx.stage.name), 1),
                createVNode("address", { class: "not-italic flex items-center gap-2" }, [
                  createVNode(unref(MapIcon)),
                  createTextVNode(" " + toDisplayString(_ctx.stage.location), 1)
                ])
              ])
            ];
          }
...
//# sourceMappingURL=index-CyC2PBS9.mjs.map

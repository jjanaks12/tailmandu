    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(showButton)) {
        _push(ssrRenderComponent(unref(Primitive), mergeProps({
          ...
          class: unref(cn)(unref(buttonVariants)({ variant: __props.variant, size: __props.size, modifier: __props.modifier }), props.class)
        }, _attrs), {
...
//# sourceMappingURL=Button-bc6lCA4h.mjs.map

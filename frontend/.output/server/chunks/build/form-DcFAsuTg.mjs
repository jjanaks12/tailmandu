import { _ as _sfc_main$1 } from './Input-0Aij7Ii7.mjs';
import { _ as _sfc_main$2 } from './Label-CR9oOPfW.mjs';
import { _ as _sfc_main$3 } from './index-BupATNYr.mjs';
import { _ as _sfc_main$4 } from './index-CS0YxOVg.mjs';
import { _ as _sfc_main$5 } from './DatePicker-BRpLtNOe.mjs';
import { _ as _sfc_main$6 } from './Textarea-DAxURKG8.mjs';
...
import { e as eventSchema } from './event.schema-B7NmTo0u.mjs';
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field, value }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  if (unref(updatedSlug) && unref(updatedSlug) == ((_a = _ctx.trailRace) == null ? void 0 : _a.slug)) {
                  ...
                  return [
                    unref(updatedSlug) && unref(updatedSlug) == ((_b = _ctx.trailRace) == null ? void 0 : _b.slug) ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "flex"
                    }, [
            ...
            return [
              ...
              createVNode(unref(Field), {
                ...
                default: withCtx(({ field, value }) => {
                  var _a;
                  return [
                    unref(updatedSlug) && unref(updatedSlug) == ((_a = _ctx.trailRace) == null ? void 0 : _a.slug) ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "flex"
                    }, [
                      createVNode(_component_Badge, null, {
...
//# sourceMappingURL=form-DcFAsuTg.mjs.map

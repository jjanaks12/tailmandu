...
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSlot, ssrRenderList } from 'vue/server-renderer';
...
import { b as useRoute, u as useEventStore, n as navigateTo, a as useAxios, s as showImage, f as __nuxt_component_11, g as getGPXFile, h as stageSchema, k as stageCategorySchema, j as checkpointSchema } from './server.mjs';
import { RefreshCwIcon, MoveLeftIcon, SaveIcon, LoaderIcon, MapIcon, PlusIcon, TrashIcon, PencilIcon, XIcon, Trash2Icon, BoldIcon, ItalicIcon, UnderlineIcon, StrikethroughIcon, RotateCcwIcon, WrapTextIcon, Heading1Icon, Heading2Icon, Heading3Icon, Heading4Icon, Heading5Icon, Heading6Icon, ListIcon, ListOrderedIcon, QuoteIcon, MinusIcon, UndoIcon, RedoIcon, LoaderCircleIcon, Loader2 } from 'lucide-vue-next';
import { f as formatDate } from './humanize-Dt8EJGgI.mjs';
import moment from 'moment';
import { u as useAuthorization } from './authorization-DPJpR6G0.mjs';
import { _ as _sfc_main$j } from './Button-BQvwvVGk.mjs';
...
import { _ as _sfc_main$4$1, a as _sfc_main$2$1, b as _sfc_main$l, c as _sfc_main$1$1 } from './DialogTitle-CZaefnAH.mjs';
import { _ as _sfc_main$k } from './DialogHeader-DOkqwiOU.mjs';
import { _ as _sfc_main$m } from './index-CIwfCEWF.mjs';
import { _ as _sfc_main$n } from './Input-DM54l6M4.mjs';
import { _ as _sfc_main$o } from './Label-jSWrZiLt.mjs';
import { _ as _sfc_main$p } from './Textarea-CAK_nurl.mjs';
import { _ as _sfc_main$q } from './DatePicker-DwR9bXOV.mjs';
import { _ as _sfc_main$6$1, a as _sfc_main$1$2, b as _sfc_main$r, c as _sfc_main$5$1, d as _sfc_main$4$2 } from './SelectValue-cH59kxAH.mjs';
import { _ as _sfc_main$s } from './DialogTrigger-BuJs-6UL.mjs';
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_TiptapEditor = _sfc_main$d;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Map, {
                    ...
                    gpxFile: unref(getGPXFile)((_a2 = _ctx.trailRace.map_file) == null ? void 0 : _a2.file_name)
                  ...
                  return [
                    ...
                    createVNode(_component_Map, {
                      "map-id": "someId",
                      center: [27.756846786775668, 85.3124535214843],
                      gpxFile: unref(getGPXFile)((_b = _ctx.trailRace.map_file) == null ? void 0 : _b.file_name)
                    }, null, 8, ["gpxFile"])
                  ];
                }
              }),
        ...
        default: withCtx(({ values }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (unref(showFile).thumbnail) {
              _push2(`<div class="w-full h-[480px] relative"${_scopeId}><img${ssrRenderAttr("src", unref(showImage)((_a = _ctx.stage) == null ? void 0 : _a.thumbnail.file_name))} class="size-full object-cover"${_scopeId}>`);
              ...
              default: withCtx(({ field }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Select, mergeProps(field, {
                    autocomplete: "sex",
                    "default-value": (_a2 = _ctx.stage) == null ? void 0 : _a2.difficulty
                  }), {
                    default: withCtx((_, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    ...
                    createVNode(_component_Select, mergeProps(field, {
                      autocomplete: "sex",
                      "default-value": (_b2 = _ctx.stage) == null ? void 0 : _b2.difficulty
                    }), {
                      default: withCtx(() => [
                        createVNode(_component_SelectTrigger, { class: "w-full" }, {
                          default: withCtx(() => [
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_DialogTitle, null, {
                            default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                              var _a3, _b3;
                              if (_push5) {
                                _push5(`${ssrInterpolate((_a3 = _ctx.stage) == null ? void 0 : _a3.name)}&#39;s map`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString((_b3 = _ctx.stage) == null ? void 0 : _b3.name) + "'s map", 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_component_Map, {
                            "gpx-file": unref(getGPXFile)((_a2 = _ctx.stage) == null ? void 0 : _a2.map_file.file_name)
                          ...
                          return [
                            createVNode(_component_DialogTitle, null, {
                              default: withCtx(() => {
                                var _a3;
                                return [
                                  createTextVNode(toDisplayString((_a3 = _ctx.stage) == null ? void 0 : _a3.name) + "'s map", 1)
                                ];
                              }),
                              _: 1
                            }),
                            ...
                            createVNode(_component_Map, {
                              "gpx-file": unref(getGPXFile)((_b2 = _ctx.stage) == null ? void 0 : _b2.map_file.file_name)
                            }, null, 8, ["gpx-file"])
                          ];
                        }
                      }),
            ...
            return [
              unref(showFile).thumbnail ? (openBlock(), createBlock("div", {
                ...
                createVNode("img", {
                  src: unref(showImage)((_b = _ctx.stage) == null ? void 0 : _b.thumbnail.file_name),
...
const useCheckpointStore = defineStore("checkpoints", () => {
  ...
  const assignVolunteerToCheckpoint = async (volunteerId, checkpointId) => {
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Button = _sfc_main$j;
      const _component_Badge = _sfc_main$m;
      const _component_Dialog = _sfc_main$4$1;
      const _component_DialogContent = _sfc_main$2$1;
      const _component_DialogHeader = _sfc_main$k;
      const _component_DialogTitle = _sfc_main$l;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$9, {
                    stageCategoryId: _ctx.stageCategoryId,
            ...
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Select, mergeProps(field, {
                    autocomplete: "sex",
                    "default-value": (_a = _ctx.category) == null ? void 0 : _a.difficulty
                  }), {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_SelectTrigger, { class: "w-full" }, {
                  ...
                  return [
                    ...
                    createVNode(_component_Select, mergeProps(field, {
                      autocomplete: "sex",
                      "default-value": (_b = _ctx.category) == null ? void 0 : _b.difficulty
                    }), {
                      default: withCtx(() => [
                        createVNode(_component_SelectTrigger, { class: "w-full" }, {
                          default: withCtx(() => [
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_DialogTitle, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              var _a2, _b2;
                              if (_push5) {
                                _push5(`${ssrInterpolate((_a2 = _ctx.category) == null ? void 0 : _a2.name)}&#39;s map`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString((_b2 = _ctx.category) == null ? void 0 : _b2.name) + "'s map", 1)
                                ];
                              }
                            }),
                            _: 1
                          ...
                          _push4(ssrRenderComponent(_component_Map, {
                            "gpx-file": unref(getGPXFile)((_a = _ctx.category) == null ? void 0 : _a.map_file.file_name)
                          }, null, _parent4, _scopeId3));
                        } else {
                          return [
                            createVNode(_component_DialogTitle, null, {
                              default: withCtx(() => {
                                var _a2;
                                return [
                                  createTextVNode(toDisplayString((_a2 = _ctx.category) == null ? void 0 : _a2.name) + "'s map", 1)
                                ];
                              }),
                              _: 1
                            }),
                            ...
                            createVNode(_component_Map, {
                              "gpx-file": unref(getGPXFile)((_b = _ctx.category) == null ? void 0 : _b.map_file.file_name)
                            }, null, 8, ["gpx-file"])
                          ];
                        }
                      }),
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DialogTitle = _sfc_main$l;
      const _component_DialogDescription = _sfc_main$1$1;
      _push(`<!--[--><div class="pt-8 pl-8"><div class="flex gap-2 pb-4 mb-5 border-b"><div class="grow"><h2>Category</h2></div>`);
      _push(ssrRenderComponent(_component_Button, {
        variant: "secondary",
        size: "sm",
        modifier: "outline",
      ...
      if (unref(stageCategories).length > 0) {
        ...
        ssrRenderList(unref(stageCategories), (stageCategory) => {
          _push(`<div><div class="flex gap-2"><div class="grow"><strong>${ssrInterpolate(stageCategory.name)}</strong><p class="mb-4">${ssrInterpolate(stageCategory.excerpt)}</p></div><div class="flex gap-2">`);
          _push(ssrRenderComponent(_component_Button, {
            variant: "secondary",
            size: "icon",
            modifier: "outline"
          ...
          _push(ssrRenderComponent(_sfc_main$8, {
            "stage-category-id": stageCategory.id
          }, null, _parent));
          _push(`</div></div>`);
        });
        _push(`<!--]--></div>`);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_Button = _sfc_main$j;
      const _component_Tabs = _sfc_main$i;
      const _component_TabsList = _sfc_main$g;
      const _component_TabsTrigger = _sfc_main$f;
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Field), {
              ...
              default: withCtx(({ field }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`<label class="inline-block align-top"${_scopeId2}>Choose a checkpoint to assign to <strong${_scopeId2}>${ssrInterpolate(_ctx.volunteer.personal.first_name)}</strong></label>`);
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_SelectTrigger, { class: "w-full h-12" }, {
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_SelectValue, { placeholder: "Select a checkpoint" }, null, _parent5, _scopeId4));
                            } else {
                              return [
                                createVNode(_component_SelectValue, { placeholder: "Select a checkpoint" })
                              ];
                            }
                          }),
                          _: 2
                        ...
                        _push4(ssrRenderComponent(_component_SelectContent, null, {
                          default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<!--[-->`);
                              ssrRenderList(_ctx.checkpoints, (checkpoint) => {
                                _push5(ssrRenderComponent(_component_SelectItem, {
                                  value: checkpoint.id
                                }, {
                                  default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`${ssrInterpolate(checkpoint.name)}`);
                                    } else {
                                      return [
                              ...
                              return [
                                (openBlock(true), createBlock(Fragment, null, renderList(_ctx.checkpoints, (checkpoint) => {
                  ...
                  return [
                    createVNode("label", { class: "inline-block align-top" }, [
                      createTextVNode("Choose a checkpoint to assign to "),
                      createVNode("strong", null, toDisplayString(_ctx.volunteer.personal.first_name), 1)
                    ]),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DialogTitle = _sfc_main$l;
      const _component_DialogDescription = _sfc_main$1$1;
      const _component_PagesDashboardEventVolunteerAssignCheckpointForm = _sfc_main$3;
      ...
      ssrRenderList(_ctx.stages, (stage) => {
        ...
        ssrRenderList(stage.volunteers, (volunteer) => {
          ...
          _push(ssrRenderComponent(_component_Badge, { variant: "outline" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${ssrInterpolate(volunteer.stages.map((stage2) => stage2.name).join(", "))}`);
              } else {
                return [
                  createTextVNode(toDisplayString(volunteer.stages.map((stage2) => stage2.name).join(", ")), 1)
                ];
              }
            }),
            _: 2
          ...
          if ((volunteer == null ? void 0 : volunteer.checkpoints.length) > 0) {
            _push(`<p>Assigned to: ${ssrInterpolate(volunteer == null ? void 0 : volunteer.checkpoints.map((checkpoint) => checkpoint.name).join(", "))}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Badge = _sfc_main$m;
      _push(`<ul${ssrRenderAttrs(mergeProps({ class: "divide-y space-y-4 [&>li]:pb-4" }, _attrs))}><!--[-->`);
      ssrRenderList(_ctx.stages, (stage) => {
        _push(`<!--[--><!--[-->`);
        ssrRenderList(stage.runners, (runner) => {
          _push(`<li class="flex gap-2 items-center"><div class="grow space-y-3"><strong class="text-lg">${ssrInterpolate(runner.personal.first_name)} ${ssrInterpolate(runner.personal.middle_name)} ${ssrInterpolate(runner.personal.last_name)} `);
          _push(ssrRenderComponent(_component_Badge, { variant: "outline" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a, _b, _c, _d;
              if (_push2) {
                _push2(`${ssrInterpolate(unref(moment)().diff(unref(moment)(runner.personal.date_of_birth), "years"))} ${ssrInterpolate((_b = (_a = runner.personal) == null ? void 0 : _a.gender) == null ? void 0 : _b.name.charAt(0).toUpperCase())}`);
              } else {
                return [
                  createTextVNode(toDisplayString(unref(moment)().diff(unref(moment)(runner.personal.date_of_birth), "years")) + " " + toDisplayString((_d = (_c = runner.personal) == null ? void 0 : _c.gender) == null ? void 0 : _d.name.charAt(0).toUpperCase()), 1)
                ];
              }
            }),
            _: 2
          }, _parent));
          _push(`</strong><em class="text-sm block not-italic">${ssrInterpolate(runner.bib)}</em>`);
          if (runner.volunteer_on_checkpoints.length > 0) {
            _push(`<ul class="text-sm space-y-1"><!--[-->`);
            ssrRenderList(runner.volunteer_on_checkpoints, (record) => {
              _push(`<li class="flex justify-between gap-1"><strong class="font-normal">${ssrInterpolate(record.checkpoint.name)}</strong><em class="not-italic">${ssrInterpolate(unref(moment)(record.timer).format("YYYY-MM-DD HH:mm:ss"))}</em></li>`);
            });
            _push(`<!--]--></ul>`);
          } else {
            _push(`<!---->`);
...
//# sourceMappingURL=_id_-CPN_q3jg.mjs.map

...
const abbr = (str) => str.split(" ").map((word) => word.charAt(0)).join("");
...
export { _sfc_main$2 as _, _sfc_main as a, _sfc_main$1 as b, abbr as c };
//# sourceMappingURL=AvatarImage-CZ_6pzRW.mjs.map

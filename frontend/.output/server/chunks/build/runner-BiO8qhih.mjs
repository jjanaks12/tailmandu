import { _ as _sfc_main$1 } from './RegistrationForm-DEGfKQbn.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_FeaturesRegistrationForm = _sfc_main$1;
  _push(ssrRenderComponent(_component_FeaturesRegistrationForm, mergeProps({ mode: "runner" }, _attrs), null, _parent));
}
...
const runner = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { runner as default };
//# sourceMappingURL=runner-BiO8qhih.mjs.map

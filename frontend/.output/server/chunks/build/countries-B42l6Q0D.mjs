                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(_component_TableCell, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`${ssrInterpolate(country.abbr.toUpperCase())}`);
                              } else {
                                return [
                                  createTextVNode(toDisplayString(country.abbr.toUpperCase()), 1)
                                ];
                              }
                            }),
                            _: 2
                          ...
                          _push4(ssrRenderComponent(_component_TableCell, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<span class="${ssrRenderClass(`flag flag-${country.abbr}`)}"${_scopeId4}></span>`);
                              } else {
                                return [
                                  createVNode("span", {
                                    class: `flag flag-${country.abbr}`
                                  }, null, 2)
                                ];
                              }
                            }),
...
//# sourceMappingURL=countries-B42l6Q0D.mjs.map

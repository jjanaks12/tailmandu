import { _ as _sfc_main$3 } from './brand-VuBHSClX.mjs';
import { _ as _sfc_main$4 } from './index-CS0YxOVg.mjs';
import { b as useAuthStore, a as useRoute, n as navigateTo, _ as __nuxt_component_0$1 } from './server.mjs';
import { _ as _sfc_main$5 } from './Skeleton-CRkCoUmX.mjs';
...
import _sfc_main$2 from './_sidebar-C5gkv9C1.mjs';
import { storeToRefs } from 'pinia';
import { u as useAuthorization } from './authorization-NeTuVL6Y.mjs';
import { _ as _sfc_main$1 } from './SidebarProvider-Cj_0prbZ.mjs';
import 'reka-ui';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Brand = _sfc_main$3;
        ...
        _push(ssrRenderComponent(_component_SidebarProvider, _attrs, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<main id="main" class="bg-gray-300 flex-grow relative"${_scopeId}><div class="bg-white px-4 py-[13px] flex justify-between items-center border-b sticky top-0 z-50"${_scopeId}>`);
              ...
              _push2(`</div></div><div class="p-4"${_scopeId}><div class="bg-white p-12 rounded-2xl overflow-hidden"${_scopeId}>`);
              ...
              return [
                ...
                createVNode("main", {
                  ...
                  createVNode("div", { class: "bg-white px-4 py-[13px] flex justify-between items-center border-b sticky top-0 z-50" }, [
...
//# sourceMappingURL=index-B08efxNg.mjs.map

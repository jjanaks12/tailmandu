...
import { _ as _sfc_main$1, a as _sfc_main$4 } from './Sonner-E4J7Itfo.mjs';
...
import _sfc_main$3 from './_header-nJQx58hd.mjs';
import _sfc_main$2 from './_sidebar-DiW1mdv0.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isLoading)) {
        _push(ssrRenderComponent(_component_SidebarProvider, _attrs, {
          default: withCtx(({ status }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_sfc_main$2, null, null, _parent2, _scopeId));
              _push2(`<main id="main" class="${ssrRenderClass({ "bg-gray-300 flex-grow relative": true, "max-w-[calc(100vw-250px)]": status })}"${_scopeId}>`);
              ...
              return [
                ...
                createVNode("main", {
                  id: "main",
                  class: { "bg-gray-300 flex-grow relative": true, "max-w-[calc(100vw-250px)]": status }
                }, [
...
//# sourceMappingURL=index-B1tuoZky.mjs.map

...
import { _ as _sfc_main$2 } from './registrationForm-CbvSHjyF.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PagesDefaultRacesRegistrationForm = _sfc_main$2;
      if (unref(trailRace)) {
        _push(`<section${ssrRenderAttrs(mergeProps({ class: "overflow-hidden" }, _attrs))}><figure class="fixed inset-0 -z-[1]"><img${ssrRenderAttr("src", unref(showImage)((_a = unref(trailRace).thumbnail) == null ? void 0 : _a.file_name))}${ssrRenderAttr("alt", unref(trailRace).name)} class="size-full object-cover"></figure><div class="container"><div class="bg-white/90 p-12 mt-12 rounded-tl-2xl rounded-tr-2xl min-h-[70vh]"><div class="space-y-4 mb-16"><h1 class="text-primary text-3xl">${ssrInterpolate((_b = unref(trailRace)) == null ? void 0 : _b.name)}</h1><p>${ssrInterpolate(unref(trailRace).excerpt)}</p><div class="flex justify-center">`);
        ...
        _push(`</div></div>`);
        _push(ssrRenderComponent(_component_PagesDefaultRacesRegistrationForm, {
...
//# sourceMappingURL=runner-Do14S1TD.mjs.map

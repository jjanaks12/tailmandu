...
<template>
    <div class="group bg-white dark:bg-deep-slate rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 dark:border-slate-800 flex flex-col h-full">
        ...
        <div class="relative aspect-[16/9] overflow-hidden">
            <img 
                :src="post.featured_image ? showImage(post.featured_image.file_name) : 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80'" 
                :alt="post.title"
        ...
        <div class="p-8 flex flex-col flex-1">
            <div class="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">
            ...
            <div class="mt-auto">
                <NuxtLink :to="`/blogs/${post.slug}`" class="inline-flex items-center gap-2 text-primary font-bold hover:gap-4 transition-all group/link">
                    Read More 

<script lang="ts" setup>
    ...
    const formSubmitted = async ({ id, ...formData }: any) => {
        ...
        if (form.value) {
            ...
            if (props.category) {
                ...
                if (props.category.start) {
                    ...
                    startDate.value = parseDate(moment(props.category.start).format('YYYY-MM-DD'))
                }
                if (props.category.end) {
                    form.value.setFieldValue('end', props.category.end)
                    endDate.value = parseDate(moment(props.category.end).format('YYYY-MM-DD'))
                }
            }
        }
    })

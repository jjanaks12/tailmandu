    ...
    <div class="space-y-2">
        ...
        <div
            ...
            <template v-if="imagePreview || value">
                ...
                <div
                    class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity gap-2">
            ...
            <template v-else>
                <div class="flex flex-col items-center p-4 cursor-pointer w-full h-full justify-center"

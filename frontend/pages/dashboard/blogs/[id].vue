...
import { ArrowLeftIcon, Loader2Icon, MessageSquareIcon, StarIcon, UserIcon, EraserIcon } from 'lucide-vue-next'
...
const clearCache = async () => {
    ...
    try {
        await axios.post(`/blogs/${route.params.id}/clear_cache`)
...
<template>
    ...
    <PagesDashboardBlogsForm v-else-if="post" :post="post" @fetch="init">
        <template #bottom-actions>
            ...
            <Button @click.prevent="clearCache" variant="destructive" modifier="outline" :loading="isClearing" size="sm">
